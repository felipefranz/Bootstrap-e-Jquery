<!-- saved from url=(0016)http://localhost --> 
    ...
    var Username;                    //Username participante
  ...
  if(!isMobileApp()){
    ...
    r = unescape(temp[1]);
    temp = window.location.href.search("[?&]p=") != -1 ? parameters[3].split("=") : "" ;
    p = unescape(temp[1]) != "undefined" ? unescape(temp[1]) : "";
    
    //Retorno String JSP ja convetido para o formato JSON
    dados_simulador = loadJson(n, g, r, p, 'view-model.jsp');
...
function loadJson(f_n, f_g, f_r, f_p, url) {
  try{
    var xmlhttp = new XMLHttpRequest();
    var Json;
    xmlhttp.open("POST", url, false);  
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xmlhttp.send("n="+f_n+"&g="+f_g+"&r="+f_r+"&p="+f_p+"");           
    //Retorno String JSP
...
function LoadSimulador(info_n){
    ...
    dados_simulador = loadJson(n, g, r, p, url);
    //Tratamento dos dados para participante não logado
    dados_simulador = dados_nao_logado(n, g, r);
    LoadDados();
    //downloadJSAtOnload();
...
imported_9.src ='https://www.portal-hro.com.br/portal/jslib/SimuladorBeneficios/Simulador_Benef/js/base_scripts/engine.js?'+ (Deslogado ? "" : Date.now());
...
function LoadDados(){ //Carregamento dos dados de simulação
...
imported_1.src ='https://www.portal-hro.com.br/portal/jslib/SimuladorBeneficios/Simulador_Benef/js/config_scripts/'+Id_entidade+'/'+Id_plano+'/config_var.js?'+ (Deslogado ? "" : Date.now());
...
imported_2.src ='https://www.portal-hro.com.br/portal/jslib/SimuladorBeneficios/Simulador_Benef/js/config_scripts/'+Id_entidade+'/'+Id_plano+'/rl_aposentadoria.js?'+ (Deslogado ? "" : Date.now());
...
imported_3.src ='https://www.portal-hro.com.br/portal/jslib/SimuladorBeneficios/Simulador_Benef/js/config_scripts/'+Id_entidade+'/'+Id_plano+'/rl_resgate.js?'+ (Deslogado ? "" : Date.now());
...
imported_4.src ='https://www.portal-hro.com.br/portal/jslib/SimuladorBeneficios/Simulador_Benef/js/config_scripts/'+Id_entidade+'/'+Id_plano+'/rl_contribuicao.js?'+ (Deslogado ? "" : Date.now());
...
imported_5.src ='https://www.portal-hro.com.br/portal/jslib/SimuladorBeneficios/Simulador_Benef/js/config_scripts/'+Id_entidade+'/'+Id_plano+'/rl_beneficio.js?'+ (Deslogado ? "" : Date.now());
...
imported_6.src ='https://www.portal-hro.com.br/portal/jslib/SimuladorBeneficios/Simulador_Benef/js/config_scripts/'+Id_entidade+'/'+Id_plano+'/rl_permissoes.js?'+ (Deslogado ? "" : Date.now());
...
imported_7.src ='https://www.portal-hro.com.br/portal/jslib/SimuladorBeneficios/Simulador_Benef/js/base_scripts/rl_ir_progressivo.js?'+ (Deslogado ? "" : Date.now());
...
imported_8.src ='https://www.portal-hro.com.br/portal/jslib/SimuladorBeneficios/Simulador_Benef/js/base_scripts/rl_ir_regressivo.js?'+ (Deslogado ? "" : Date.now());
