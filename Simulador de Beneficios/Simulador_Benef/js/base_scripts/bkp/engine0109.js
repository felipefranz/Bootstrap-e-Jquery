  ...
  for (i in jsonObj){
    ...
    if (obj.conta_resp == 1 && obj.perfil == NomePerfil1 && obj.id_conta != 1245 && obj.id_conta != 1246){
      ...
      switch (obj.tipo_tribut){
        ...
        break;
        case "p":
          IRResgPatroc1 += obj.ctr_quotas * qt1 * percDirPatrocResg * 0.15;
    ...
    if (obj.conta_resp == 1 && obj.perfil == NomePerfil2 && obj.id_conta != 1245 && obj.id_conta != 1246){
      ...
      switch (obj.tipo_tribut){
        ...
        break;
        case "p":
          IRResgPatroc2 += obj.ctr_quotas * qt2 * percDirPatrocResg * 0.15;
    ...
    case 0:
      $("#slider").slider({
        ...
        //Atualizar opção por nova forma de recebimento e valor do benef&iacute;cio ao movimentar o Slider - ui = user interface
          ...
          if (OpcaoTribut == "S"){
            var resultIRReg = IRRegBenef(Benef + (SlideValSaque * SaldoIniT), SaldoIniT10PosSaque, SaldoIniT15PosSaque, SaldoIniT20PosSaque, SaldoIniT25PosSaque, SaldoIniT30PosSaque, SaldoIniT35PosSaque, SaldoIniTProgPosSaque, SaldoIniTIsenPosSaque);
...
do{
  ...
  if (BenMinListener == 1){
        $("#graSalProjeta").fadeIn();        
      }else{
        $("#graSalProjeta").fadeOut();
      }
