...
var BenMinListener = 0;                           //Verificar se o benefício mínimo foi atingido [0 - Não, 1 - Sim]
...
function IdadeBar(){
  ...
  $("#age").val(SlideValIdade + " anos");
  DtSaldoDIB = DtSaldoDIB = new Date(ProxAno(DtSaldoIni , SlideValIdade - DataDif(Ncmto, DtSaldoIni, 0, 2)));
  $("#dtage").val("(Data Projetada: " + $.formatNumber(DtSaldoDIB.getMonth() + 1, {format: "00", locale: "br"}) + "/" + DtSaldoDIB.getFullYear() + ")");
  idadeImg();
}
...
function EvolSaldo(opt){
    ...
    GridEvol = GridEvol + "<tr><th>Idade</th><th>Benefício Projetado</th><th>Saldo Remanescente</th></tr>";
