...
var CrescSalaa = 0.027;                            //% crescimento salarial a.a.
var ROIaa1 = 0.045;                                //Meta atuarial ao ano do Plano - Perfil 1, 2018 - 0.0436
var ROIaa2 = 0.00;                                //Meta atuarial ao ano do Plano - Perfil 2
var ValPerc = 0;                               //Valor inicial da forma de pagamento Percentual
var MinPerc = 0;                               //Valor mínimo da forma de pagamento Percentual
var MaxPerc = 0;                                  //Valor máximo da forma de pagamento Percentual
...
var Tabua = [];                                    //Array Tabua Atuarial
...
var pgtoPercHabilit = false;
var pgtoPrazoHabilit = false;
var pgtoRendaHabilit = false;
var pgtoRendaHabilitaSlider = true; //flag de controle para habilitar funcionamento de simulação de renda certa pelo componente slider, default false componente input
...
var url_Home = '/portal/site/Tramontinaprev/';
...
var secContrib_urp = "URT:";  	                         //Texto URP
...
for (var l in DadosPlano.Tabua){
        ...
        Tabua.push({ idade: parseInt(obj.Idade), fator_masc: parseFloat(obj.FatorMasc), fator_fem: parseFloat(obj.FatorFemin)});
    };
