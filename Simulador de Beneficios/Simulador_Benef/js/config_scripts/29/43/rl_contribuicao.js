...
function Monta_Contrib(){
    ...
    var ctr1fd = new tbfld(fnc17, "", fnc1, "", fnc3);
...
function Contrib_Control(){
  ...
  */  
    ...
    for (x = 0; x <= 12; x += 12){ //0, 1 2 3 4 5 5,5   
...
//----------------------------------------------------- Inicializa Contribuições ---------------------------------------------------------              
    ...
    ContribCalc[0][3] = 0;           
    /*
    $('#fnc21').val("" + $.formatNumber(contrib_patroc, {format: "#,##0.00", locale: "br"})+"%");
...
function SaldoAdicional_1(JSONobj){
 if (JSONobj.conta_resp == 0 && JSONobj.perfil == NomePerfil1 && (JSONobj.id_conta == 1245 || JSONobj.id_conta == 1246 || JSONobj.id_conta == 1285 || JSONobj.id_conta == 1286)){
    return true;
  }else{
    return false;
  }
...
function SaldoAdicional_2(JSONobj){
 if (JSONobj.conta_resp == 0 && JSONobj.perfil == NomePerfil2 && (JSONobj.id_conta == 1245 || JSONobj.id_conta == 1246 || JSONobj.id_conta == 1285 || JSONobj.id_conta == 1286)){
    return true;
  }else{
    return false;
  }
