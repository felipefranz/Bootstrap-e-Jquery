...
var ValRenda = 0.005;                            //Valor percentual inicial da forma de pagamento onde, Renda Certa Inicial = Saldo de benefício disponível * ValRenda
var MinRenda = 0.005;                            //Valor percentual mínimo da forma de pagamento onde, Renda Certa Min = Saldo de benefício disponível * MinRenda
var MaxRenda = 0.02;                              //Valor percentual máximo da forma de pagamento onde, Renda Certa Max = Saldo de benefício disponível * MaxRenda
var IncRenda = 0.001;                            //Incremento da forma de pagamento Renda Certa em R$
var MinBenef = URP * 0.1;                         //Valor mínimo para pagamento do benefício mensal
...
var DtLimiteTVP = new Date("12/13/2002");        //Data parâmetro de contagem TVP, onde antes dessa data considera dtadmissão, depois considera dtadesao
var DtInicialTVP = (new Date(DtAdmissao) <= DtLimiteTVP) ? new Date(DtAdmissao) : new Date(DtAdesao); //Data inicial para contagem de TVP
var TabuaAtuarial = DadosPlano.Tabua_Atuarial;    //Tabua Atuarial do plano
var Contribuinte = DadosPlano.Contribuinte;       //Flag de identificação 0 = Não Contribuinte e 1 = Contribuinte
...
var url_Home = '/portal/site/Carrefourprev/';
...
var secContrib_urp = "URC:";  	                         //Texto URP
...
var tamBeneBox_amount	=	"Benefício Bruto:";  	                                     //Texto Benefício Inicial Bruto
var tamBeneBox_benefIrValue	=	"IR Benefício:";  	                                //Texto IR Benefício Inicial
...
var secVitalicio_Desconto = "Desconto:";                                                    //Texto valor de desconto
var secVitalicio_Liquido = "Líquido:";                                                      //Texto valor de liquido
var secVitalicio_fldMyBenAdic = "Saldo transformado em renda financeira:";                  //Texto aviso de saldo adicional disponível
var secVitalicio_msg2 = "Benefício adicional.";                                             //Texto alert mensagem 2 Saldo Adicional
