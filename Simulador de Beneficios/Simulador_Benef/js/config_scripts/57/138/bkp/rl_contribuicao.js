...
//Function para geração de formulário de contribuição extraordinária
function GerarForm()
{
  var numContrib = document.getElementById('contrib').value;
  var resultNumExtenso = numContrib + " ("+new String(numContrib).extenso(true)+"),";;
  ...
  form.urlGo.value = 'http://localhost:65073/Private/ClientModule/Reports/pdfCreator.aspx?rptCod=24&contrib='+resultNumExtenso;
