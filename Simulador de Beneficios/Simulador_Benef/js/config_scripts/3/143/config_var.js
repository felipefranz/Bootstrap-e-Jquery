...
var MaxPrazo = 50;                                //Valor máximo da forma de pagamento Prazo
var IncPrazo = 1 / Nper;                          //Incremento da forma de pagamento Prazo
var ValRenda = 0.5;                            //Valor percentual inicial da forma de pagamento onde, Renda Certa Inicial = Saldo de benefício disponível * ValRenda
var MinRenda = 0.5;                            //Valor percentual mínimo da forma de pagamento onde, Renda Certa Min = Saldo de benefício disponível * MinRenda
var MaxRenda = 1.5;                            //Valor percentual máximo da forma de pagamento onde, Renda Certa Max = Saldo de benefício disponível * MaxRenda
var IncRenda = 0.01;                             //Incremento da forma de pagamento Renda Certa em R$
var MinBenef = URP;                               //Valor mínimo para pagamento do benefício mensal
var DtEfetPlano = new Date("09/01/1995");         //Data efetiva do plano Oesprev
...
var secContrib_urp = "URO:";  	                         //Texto URP
...
var tamBeneBox_renda	=	"Renda em R$";                                                         //Texto Renda Certa
