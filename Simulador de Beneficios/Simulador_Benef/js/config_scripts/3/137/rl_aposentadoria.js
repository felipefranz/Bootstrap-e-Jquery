...
function DireitoAposent(){                     
  ...
  if (DataDif(new Date(DtEfetPlano), DtAdesao, 0, 0) <= 60 && DtAdmissao < DtPartFundador){   //Participante Fundador é aquele que tenha sido admitido antes de 30/03/1997 e seja efetivo no plano até 60 dias contados a partir de 01/10/1997 (data efetiva do plano) 
