...
var MaxPrazo = 30;                                //Valor máximo da forma de pagamento Prazo
...
var URAG = DadosPlano.URAG;                 //Valor Unidade de Referência Guarani atualizada em 07/2016
var MinBenef = 5 * URAG;                              //Valor mínimo para pagamento do benefício mensal
...
var secContrib_urp = "UPG:";  	                         //Texto URP
var secContrib_urg = '<div class="col-xs-12 col-sm-12 col-md-12" align="left"><label for="urg"><span id="secContrib_urg">URG:</span></label><input type="text" id="urg" size="10" style="border:0;" readonly=""></div>'; //Div valor URG Implementada ao corpo HTML
...
var tamBeneBox_benefIrValue	=	"IR Inicial:";  	                                //Texto IR Benefício Inicial
...
var CopyrigtText	=	"&copy; Bradesco | MultiPensions "+text_Ano+".";	        //Texto rodapé concatenado com o nome da entidade abreviado
var MinBenText = "Valor mínimo de benefício atingido. Benefício transformado em pagamento único. Favor entrar em contato com a Patrocinadora.";    //Texto pagamento único
...
document.getElementById("secSalURP").innerHTML += secContrib_urg;  // Adicionar URAG ao HTML, URAG só existe para este plano
$("#urg").val(" R$ " + $.formatNumber(URAG, {format: "#,##0.00", locale: "br"})); //Set valor URG
