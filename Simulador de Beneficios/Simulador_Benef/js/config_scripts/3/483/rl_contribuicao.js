...
//------------------------------------------------------- Eventos Change --------------------------------------------------------- 
    ...
    $('#fnc1').change(function() {
      ...
      if (isNaN($('#fnc1').val())){
        ...
        $('#fnc27').html('<strong>Atenção!</strong> Valor de contribuição normal acima do permitido, digite um novo percentual.');
        $('#fnc12').html('A Contribuição eventual Participante está sujeita à avaliação de margem salarial disponível.');          
        $('#fnc27').fadeIn();
        $('#fnc12').fadeIn();
        $('#fnc1').val("");
        $('#fnc1').focus();                          
  ...
  $('#fnc21').change(function () {
      ...
      if (isNaN($('#fnc21').val())){
        ...
        setTimeout(function(){$('#fnc27').fadeOut();}, 4000);
          ...
          $('#fnc12').html('<strong>Atenção!</strong> Contribuição eventual não pode ser inferior a 1%.');  
          $('#fnc12').fadeIn();
          $('#fnc21').val("");        
          $('#fnc23').val("R$ " + $.formatNumber(0, {format: "#,##0.00", locale: "br"}));
          ContribCalc[2][0] = 0;
        ...
        $('#fnc27').html('<strong>Atenção!</strong> Valor de contribuição eventual acima do permitido, digite um novo percentual.');
        $('#fnc12').html('A Contribuição eventual Participante está sujeita à avaliação de margem salarial disponível.');          
        $('#fnc27').fadeIn();
        $('#fnc12').fadeIn();
        $('#fnc21').val("");
   ...
   $('#fnc9').change(function () {
      ...
      /*  
          ...
          $('#fnc12').html('<strong>Atenção!</strong> Contribuição Voluntária não pode ser inferior a 10%.');  
          $('#fnc12').fadeIn();
          $('#fnc21').val("");        
          $('#fnc23').val("R$ " + $.formatNumber(0, {format: "#,##0.00", locale: "br"}));
          ContribCalc[2][0] = 0;
        ...
        $('#fnc27').html('<strong>Atenção!</strong> Valor de contribuição voluntária acima do permitido, digite um novo valor.');
...
function checkBasica(){  //Retorna quantidade de pagamento Contrib Basica participante
  ...
  var contaBasica = 0; //Conta quantidade de contribuições Basica participante    
  ...
  if(i > -1){
    ...
    do {
      ...
      if ((movto.id_conta == 1201 || movto.id_conta == 1123 || (movto.id_conta == 0 && movto.ctr_quotas > 0)) && movto.conta_resp == 0){ //Se Conta Basica e Responsável Participante = True
        contaBasica++;
      }
      i--;
    } while(i >= 0)
