...
function Monta_Contrib(){
    ...
    var ctr3fd = new tbfld(fnc17, "", "", "", fnc18);        
    ...
    var ctr5hd = new tbfld("", "Tipo", fnc13 + fnc14, "Periodicidade", "Contrib. Simulada");
...
function Contrib_Control(){
    ...
    $('#fnc18').val("R$ " + $.formatNumber(0.02 * (Salario - 10 * URP), {format: "#,##0.00", locale: "br"}));
    $('#tblCtr3').hide();
    ...
    //Inicializa Contribuições
      ...
      $('#fnc18').val("R$ " + $.formatNumber(0.02 * (Salario - 10 * URP), {format: "#,##0.00", locale: "br"}));
      ContribCalc[2][0] = 0.02 * (Salario - 10 * URP);
      ContribCalc[2][1] = 1;
      ContribCalc[2][2] = 1;
      ContribCalc[2][3] = 0;
      ...
      $('#fnc18').val("R$ " + $.formatNumber(0, {format: "#,##0.00", locale: "br"}));
      ContribCalc[2][0] = 0;
      ContribCalc[2][1] = 1;
      ContribCalc[2][2] = 1;
      ContribCalc[2][3] = 0;
