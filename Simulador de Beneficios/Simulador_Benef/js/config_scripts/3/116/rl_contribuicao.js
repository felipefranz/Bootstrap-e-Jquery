...
//----------------------------------------------------- Inicializa Contribuições ---------------------------------------------------------  
    ...
    //Inicializa Contribuições
      ...
      } else if (Salario > (4 * URP) && Salario <= (8.5 * URP)){            
      ...
      } else if (Salario > (8.5 * URP)){
      
      $('#fnc1').hide();
      $('#fnc2').show();      
      
      $('#fnc3').val("R$ " + $.formatNumber(Salario * $('#fnc2').val(), {format: "#,##0.00", locale: "br"})); 
      ContribCalc[0][0] = Salario * $('#fnc2').val();
      ContribCalc[0][1] = 0;
      ContribCalc[0][2] = 1;
      ContribCalc[0][3] = 0;
