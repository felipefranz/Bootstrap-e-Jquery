...
function Monta_Contrib(){
    ...
    var fnc15 = '<span id="fnc15">Contribuição Voluntária<span>';
    var fnc16 = '<span id="fnc16">1ª Faixa</span>';
    ...
    var ctr1fd = new tbfld("Contribuição Básica", fnc1, "", "", fnc3);

    //config grupo contribui&ccedil;&atilde;o 2
    var ctr2hd = new tbfld("", "", "", "", "Contrib. Simulada");
    var ctr2fd = new tbfld("Contribuição Normal", "", "", "", fnc10);
