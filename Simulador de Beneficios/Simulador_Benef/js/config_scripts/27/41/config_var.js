...
var ROIaa1 = 0.0439;                                //Meta atuarial ao ano do Plano - Perfil 1
var ROIaa2 = 0.00;                                //Meta atuarial ao ano do Plano - Perfil 2
var ValPerc = 0.05;                               //Valor inicial da forma de pagamento Percentual
var MinPerc = 0.05;                               //Valor mínimo da forma de pagamento Percentual
...
var ValRenda = 0.05;                            //Valor percentual inicial da forma de pagamento onde, Renda Certa Inicial = Saldo de benefício disponível * ValRenda
var MinRenda = 0.05;                            //Valor percentual mínimo da forma de pagamento onde, Renda Certa Min = Saldo de benefício disponível * MinRenda
var MaxRenda = 3;                              //Valor percentual máximo da forma de pagamento onde, Renda Certa Max = Saldo de benefício disponível * MaxRenda
var IncRenda = 0.01;                            //Incremento da forma de pagamento Renda Certa em R$
var MinBenef = URP * 0.5;                         //Valor mínimo para pagamento do benefício mensal
...
var HabilitaMultiBeneficio = true;
var desabilitaMeta = false;
var desabilitaMeta2 = true;
var desabilitaSalGrow = false;
var pgtoRendaHabilitaSlider = false; //flag de controle para habilitar funcionamento de simulação de renda certa pelo componente slider, default false componente input
var url_Home = '/portal/site/novo-portal-rbsprev/';
...
var secContrib_urp = "URBS:";  	                         //Texto URP
