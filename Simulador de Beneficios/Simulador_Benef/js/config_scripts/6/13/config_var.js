...
var ValRenda = 0.1;                           //Valor percentual inicial da forma de pagamento onde, Renda Certa Inicial = Saldo de benefício disponível * ValRenda
var MinRenda = 0;                             //Valor percentual mínimo da forma de pagamento onde, Renda Certa Min = Saldo de benefício disponível * MinRenda
var MaxRenda = 2.5;                           //Valor percentual máximo da forma de pagamento onde, Renda Certa Max = Saldo de benefício disponível * MaxRenda
var IncRenda = 0.1;                           //Incremento da forma de pagamento Renda Certa em R$ min 0,00004
...
//var CampAlterBeneficio = new Date() >= new Date(2020, 7, 18, 8) && new Date() <= new Date(2020, 8, 6, 23,59) ? true : false;                    //Flag de ativação de campanha de alteração de benefícios (campo mês é um array, iniciado com 0)
var CampAlterBeneficio = new Date() >= new Date(2020, 4, 18, 8) && new Date() <= new Date(2020, 5, 6, 23,59) ? true : false;                    //Flag de ativação de campanha de alteração de benefícios (campo mês é um array, iniciado com 0)
