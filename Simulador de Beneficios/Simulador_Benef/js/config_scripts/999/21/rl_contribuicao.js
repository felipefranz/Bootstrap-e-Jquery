...
function Contrib_Control(){
    ...
    $('#fnc6').change(function() {
      $('#fnc8').val("R$ " + $.formatNumber((Salario - 10 * URP) * $('#fnc2').val() + (Salario >= (10 * URP) ? (10 * URP) * $('#fnc6').val() : Salario) * $('#fnc1').val() * $('#fnc6').val(), {format: "#,##0.00", locale: "br"}));
      ContribCalc[2][0] = (Salario - 10 * URP) * $('#fnc2').val() + (Salario >= (10 * URP) ? (10 * URP) : Salario) * $('#fnc1').val() * $('#fnc6').val();
      ContribCalc[2][1] = 0;
      ContribCalc[2][2] = 1;
    });
