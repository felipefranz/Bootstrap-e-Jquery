...
var CrescSalaa = 0.02;                             //% crescimento salarial a.a.
...
var MinBenef = 0.0;                              //Valor mínimo para pagamento do benefício mensal
var SaldoMin = 0;                      //Valor do saldo mínimo para pagamento único
var UltContribAdic = 414.57;                    //Valor da última contribuição de adicional
var TabuaAtuarial  = [];                                    //Array Tabua Atuarial do plano
var QuotaDesligado = DadosPlano != null ? DadosPlano.QuotaDesligado : "";  //Quota na data do desligamento do participante
var Contribuinte = 0;  // DadosPlano.Contribuinte;       //Flag de identificação 0 = Não Contribuinte e 1 = Contribuinte
...
var url_Home = '/portal/site/Avonprev';
...
var home_text =	'<a onclick="window.history.back();" class="navbar-link">Voltar</a>';  	            //Link Home
...
var secSaldo_fldCompanyBalance = "Saldo da AVON";  	    //Texto Saldo da Empresa
...
var secContrib_urp = "URA:";  	                         //Texto URP
...
for (var l in DadosPlano.Tabua_Atuarial){
        var obj = DadosPlano.Tabua_Atuarial[l];
        TabuaAtuarial .push({ Idade: parseInt(obj.Idade), Masculino: parseFloat(obj.FatorMasc), Feminino: parseFloat(obj.FatorFemin)});
    };
