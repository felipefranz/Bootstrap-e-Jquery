...
function Monta_Contrib(){
    ...
    var fnc15 = '<span id="fnc15">Contribui&ccedil;&atilde;o Adicional<span>';
    var fnc16 = '<textarea>Enter text here...</textarea>'
    
    //config grupo contribui&ccedil;&atilde;o 1
    var ctr1hd = new tbfld("", "%", "", "", "Contrib. Simulada");
    var ctr1fd = new tbfld("Contribui&ccedil;&atilde;o Básica", fnc1, "", "", fnc3);
...
function Contrib_Control(){
    ...
    ContribCalc[2][0] = Salario * $('#fnc6').val(); //valor da contribui&ccedil;&atilde;o
