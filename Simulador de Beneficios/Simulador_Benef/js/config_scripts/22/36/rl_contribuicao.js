...
function Monta_Contrib(){
    ...
    var fnc2 = '<select class="form-control input-sm" id="fnc2" size="1" style="width:100px"></select>';
    ...
    var fnc20 = '<span id="fnc20">Suplementar Participante<span>';    
            
    
    //config grupo contribuição 1
    var ctr1hd = new tbfld("", "%", "", "", "Contrib. Simulada");
    ...
    var ctr4fd = new tbfld(fnc17, "", "", "", fnc10);
...
function Contrib_Control(){
    var x = 0;
    var idade = DataDif(new Date(Ncmto.getMonth() + 1 + "/01/" + Ncmto.getFullYear()), DtSaldoIni, 0 , 2);
    var perc_contrapartida = 1;
    ...
    ContribCalc[0][2] = 1;
    ContribCalc[0][3] = 0;
    $('#fnc19').val("R$ " + $.formatNumber(ContribCalc[0][0] * $('#fnc2').val(), {format: "#,##0.00", locale: "br"}));
    ContribCalc[3][0] = ContribCalc[0][0] * $('#fnc2').val();
    ContribCalc[3][1] = 0;
    ContribCalc[3][2] = 1;
    ContribCalc[3][3] = 0;    
    switch(true) {
    case (idade > 40 && idade < 51):
        perc_contrapartida = 2;
        break;
    case (idade > 51):
        perc_contrapartida = 3;
        break;
    };
    
    $('#fnc10').val("R$ " + $.formatNumber(ContribCalc[0][0] * perc_contrapartida, {format: "#,##0.00", locale: "br"}));
    ContribCalc[1][0] = ContribCalc[0][0] * perc_contrapartida;
    ContribCalc[1][1] = 1;
    ContribCalc[1][2] = 1;
    ContribCalc[1][3] = 0;
