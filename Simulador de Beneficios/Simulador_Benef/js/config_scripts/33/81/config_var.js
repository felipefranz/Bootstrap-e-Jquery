...
var MaxPerc = 1.5;                              //Valor máximo da forma de pagamento Percentual
var IncPerc = 0.05;                              //Incremento da forma de pagamento Percentual
var ValPrazo = 10;                               //Valor inicial da forma de pagamento Prazo
var MinPrazo = 10;                               //Valor mínimo da forma de pagamento Prazo
...
var MinRenda = 0.001;                            //Valor percentual mínimo da forma de pagamento onde, Renda Certa Min = Saldo de benefício disponível * MinRenda
var MaxRenda = 0.015;                           //Valor percentual máximo da forma de pagamento onde, Renda Certa Max = Saldo de benefício disponível * MaxRenda
var IncRenda = 0.0005;                            //Incremento da forma de pagamento Renda Certa em R$
var MinBenef = URP * 2;                             //Valor mínimo para pagamento do benefício mensal
var SaldoMin = URP * 2;                      		      //Valor do saldo mínimo para pagamento único
...
var CampAlterBeneficio = false; //new Date() >= new Date(2018, 10, 22, 8) && new Date() <= new Date(2018, 11, 5, 17) ? true : false;                    //Flag de ativação de campanha de alteração de benefícios
var DtInicialPlano = new Date("09/04/2013");          //Data Comparativa para aposentadoria antecipada
//var DtInicialPlanoQuaker = new Date("06/06/1994");          //Data Comparativa para aposentadoria antecipada
var TabuaAtuarial = [];                                    //Array Tabua Atuarial
var QuotaDesligado = DadosPlano.QuotaDesligado;  //Quota na data do desligamento do participante
var SalarioDesligado = DadosPlano.SalarioDesligado;  //Salário na data do desligamento do participante
...
var url_Home = 'https://prevpepsico.com.br/';
...
var secContrib_nomePlan	=	'Simule abaixo as contribuições futuras ao '+nome_plano_abrev.toUpperCase()+' para composição do benefício de aposentadoria, a partir de seu saldo atual.';  //Texto Campo Mensagem para simulação
...
for (var l in DadosPlano.Tabua){
        ...
        TabuaAtuarial.push({ idade: parseInt(obj.Idade), fator_masc: parseFloat(obj.FatorMasc), fator_fem: parseFloat(obj.FatorFemin)});
    };
