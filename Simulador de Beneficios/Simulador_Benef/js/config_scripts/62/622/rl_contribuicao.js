...
if(is_ie){ //Se for IE
  secContribtblCtr1 = '<a id="secContribtblCtr1" class="fa fa-question-circle-o fa-2" style="color:black; font-size:15px; background-color: white;border-radius: 60%;" data-toggle="tooltip" data-placement="bottom" title="A contribuição será igual à parcela do salário que exceder 15 UPs multiplicado por 7%."></a>';   
} else {
  secContribtblCtr1 = '<i id="secContribtblCtr1" class="fa fa-question-circle-o fa-2" style="font-size:15px; background-color: white;border-radius: 60%;" aria-hidden="true" data-toggle="tooltip" data-placement="bottom"  title="A contribuição será igual à parcela do salário que exceder 15 UPs multiplicado por 7%."></i>';
}
...
function Monta_Contrib(){
    ...
    var ctr1fd = new tbfld("Básica Participante  " + secContribtblCtr1,  fnc1, "", "", fnc3);
...
function catchContribuicao(){  //Captura pagamento pela conta suplementar, Voluntaria
  ...
  do {
    ...
    if ((movto.id_conta == 1202) && movto.conta_resp == 0 && ctrCatchBas == 0 && movto.competencia <= DtBase){ //Pega a última Contrib Basica
