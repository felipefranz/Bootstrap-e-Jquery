...
var ValPerc = 0.3;                                //Valor inicial da forma de pagamento Percentual
var MinPerc = 0.3;                               //Valor mínimo da forma de pagamento Percentual
var MaxPerc = 1.0;                                //Valor máximo da forma de pagamento Percentual
var IncPerc = 0.1;                               //Incremento da forma de pagamento Percentual
var IncPrazo = 1;                           //Incremento da forma de pagamento Prazo 1/Nper
var ValPrazo = 5;                                 //Valor inicial da forma de pagamento Prazo
var MinPrazo = 5;                                 //Valor mínimo da forma de pagamento Prazo
var MaxPrazo = 35;                                //Valor máximo da forma de pagamento Prazo
...
var MinBenef = 0;                              //Valor mínimo para pagamento do benefício mensal
var SaldoMin = 25 * URP;                      		       //Valor do saldo mínimo para pagamento único 100 * URP
...
var url_Home = '/portal/site/UltraPrev';

flagIRResgateProg = 1;                           //Flag de controle para calculo de IR do resgate progressivo, 0 = IR Tab Progressiva (Default) / 1 = IR 15%

url_retorno = url_retorno.replace(":84", "");
url_retorno = url_retorno.replace("http:", "https:");
...
var secSaldo_fldMyBalance	= "Saldo Participante";  	                //Texto Meu Saldo
var secSaldo_fldCompanyBalance = "Saldo Patrocinadora";  	    //Texto Saldo da Empresa
